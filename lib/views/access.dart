...
import 'package:fluent_ui/fluent_ui.dart' hide IconButton, FilledButton, Card;
  ...
  Widget _buildInstalledAppsPermissionStatus() {
    ...
    return NullStatus(
      ...
      action: FilledButton.tonalIcon(
        ...
        icon: const Icon(WindowsIcons.unlock),
  ...
  Widget _buildBannerBar({
    ...
    if (!enable) {
      return MaterialBanner(
        leading: Icon(WindowsIcons.info, color: context.colorScheme.outline),
        content: Text(
