...
void main() {
  testWidgets(
    ...
    (tester) async {
      ...
      expect(find.byIcon(WindowsIcons.check_mark), findsOneWidget);
      ...
      expect(find.byIcon(WindowsIcons.check_mark), findsNothing);
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      await tester.pump();
      expect(find.byIcon( WindowsIcons.update_restore), findsOneWidget);
  ...
  testWidgets('holds connecting when restarting from disconnected', (
    ...
    await tester.pump(const Duration(milliseconds: 400));
    expect(find.byType(CommonCircleLoading), findsOneWidget);
    expect(find.byIcon(WindowsIcons.update_restore), findsNothing);
